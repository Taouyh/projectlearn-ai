...
每完成一个重要 Task，都需要检查 `README.md`、`ROADMAP.md` 和对应的 Task 文档是否需要同步。
...
1. 更新对应的 `TASK-XXX.md`。
2. 根据实际情况更新 `ROADMAP.md`。
3. 判断 `README.md` 是否需要增量更新。
4. 检查 Git diff。
5. 确认没有修改与当前 Task 无关的内容。
6. 再由开发者决定是否 commit / push。

README 是否更新应该根据项目实际变化判断，而不是每完成一个 Task 都强制修改 README。
